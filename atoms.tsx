...
export const CameraStreamAtom = atom<MediaStream | null>(null); // Added
export const IsCameraActiveAtom = atom<boolean>((get) => !!get(CameraStreamAtom)); // Added derived atom
